...
//Function to generate an index where Player2 places a piece.
...
int main()
{
	...
	//If the Player2 process is launched, this sentence will be outoput.
	cout << "Successful Launch of Player2 Process" << endl;
...
void CreateWriteFile(int _x, int _y) {
	...
	LPCSTR  lpFileName1 = "../Manager/StatsXP2.txt";  //Specify the location of the file 
	LPCSTR  lpFileName2 = "../Manager/StatsYP2.txt";  //that will write the X, Y value 
	...
	cout << "Sucsessful Create File StatsYP2" << endl; //Output this strings if hFileY can be opend
	...
	cout << "Sucsessful Write File StatsXP2" << endl; //Output this strings if successful send the data to the parent process
